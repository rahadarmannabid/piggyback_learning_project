...
from kids_routes import router_api as kids_api_router, router_pages as kids_pages_router
app.include_router(kids_api_router, prefix="/api")
app.include_router(kids_pages_router)
